...
<title>新用户注册页面</title>
	...
	<script type="text/javascript">
		function changeStatus(obj){
			...
			}else if('graduate'==obj.value){
				/* obj.style.display="block"; */
				/* var text1=document.getElementById('univer1'); */
			 	/* text1.style.display="block";  */
			 	$(".gra_spe").css("display",'table-row');
			 	$(".worker_sep").css("display",'none');
			 	
			}else if('midstu'==obj.value){
				alert(obj.value);
			}
			else if ('nothing'==obj.value) {
				alert(obj.value);
			}
		}
	</script> 
...
<body>
	...
	<!-- 右侧区域 ，注册用的表格-->
	   ...
	   <input type="hidden" name="universityId" id="university" />
